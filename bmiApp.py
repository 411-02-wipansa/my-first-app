...
st.marker("# :red[🔎 คำนวณค่าดัชนีมวลกาย BMI]")
...
if st.button("🧮 คำนวณค่า BMI "):
  # แปลงส่วนสูงจาก cm เป็น เมตรทแล้วคำนวณ BMI
...
if bmi < 18.5:
  ...
  st.error("🚨 คุณมีน้ำหนักเกินเกณฑ์ ควรระวังเรื่องสุขภาพและออกกกำลังกาย")

st.divider()
sr.write("นางสาววิพรรสา ศรีแก้ว เลขที่ 2 ม.4/11")
